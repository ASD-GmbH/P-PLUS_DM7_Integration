...
namespace DM7_PPLUS_Integration.Implementierung.Testing
{
    public static class TestConnector
    {
        ...
        {
            return Connector.Instance_API_level_0_nur_fuer_Testzwecke(networkAddress, "test", log, CancellationToken.None, factory);
        }
        ...
        {
            return Connector.Instance_API_Level_1(networkAddress, "test", log, cancellationToken_Verbindung, factory);
        }
        ...
        {
            return Connector.Instance_API_Level_3(networkAddress, "test", log, cancellationToken_Verbindung, factory);
        }
    }
}