...
namespace DM7_PPLUS_Integration.Implementierung.Testing
{
    public static class TestConnector
    {
        ...
        public static Task<DM7_PPLUS_API> Instance_API_Version_1(string networkAddress, Log log, CancellationToken cancellationToken_Verbindung, Schicht_2_Proxy_Factory factory = null)
        {
            return Connector.Instance_API_Version_1(networkAddress, "test", log, cancellationToken_Verbindung, factory);
        }

        public static Task<DM7_PPLUS_API> Instance_API_Version_3(string networkAddress, Log log, CancellationToken cancellationToken_Verbindung, Schicht_2_Proxy_Factory factory = null)
        {
